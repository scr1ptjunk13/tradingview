...
export default function MainToolbar({}: MainToolbarProps) {
  const {
    isCollapsed,
    toggleCollapse,
    activeToolId,
          ...
          return (
            <ToolButton
              ...
              isActive={
                ...
                // For remove-tool, it's active if its submenu is open or if one of its sub-items is active
                (tool.id === "remove-tool" && isToolOrSubtoolActive(tool))
              }
              onClick={
